...
import com.badlogicgames.superjumper.World_jump.WorldListener;

public class GameScreen_jump extends ScreenAdapter {
	...
	public GameScreen_jump(SuperJumper game) {
		this.game = game;
		...
		world = new World_jump(worldListener);
		renderer = new WorldRenderer_jump(game.batcher, world);
	...
	private void updateRunning (float deltaTime) {
		...
		if (world.state == World_jump.WORLD_STATE_NEXT_LEVEL) {
			game.setScreen(new WinScreen(game));
		}
		if (world.state == World_jump.WORLD_STATE_GAME_OVER) {
			state = GAME_OVER;
